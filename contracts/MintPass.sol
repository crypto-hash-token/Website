...
/*
* @title ERC1155 token for Crypto Hash Mint Pass
* @author Niftydude Edited by Bodhi
*/
contract MintPass is AbstractERC1155Factory, PaymentSplitter  {

    uint256 constant MAX_SUPPLY = 250;
    uint256 constant MAX_EARLY_ACCESS = 250;

    uint8 maxPerTx = 2;
    uint8 maxTxPublic = 2;
    uint8 maxTxEarly = 1;

    uint256 public mintPrice = 080000000000000000;
